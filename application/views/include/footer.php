            ...
            <div class="app-footer app-footer-default" id="footer">
                ...
                <div class="app-footer-line extended">
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            <img src="assets/images/users/logo.png">                            
                            <div align="justify"><p>Agro Hub is a Mobile and web-based Agricultural Value Chain project Monitoring, Evaluation, Data Capturing and Reporting Management Information System. </p></div>
                ...
                <div class="app-footer-line darken">                
                    <div class="copyright wide text-center">Copyright &copy; 2017 Agro Hub. All right reserved.</div>                
                </div>
            </div>
            <!-- END APP FOOTER -->
        ...
        <!-- END APP SCRIPTS -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/app_demo_dashboard.js"></script>
    </body>
</html>